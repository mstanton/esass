...
from esass.mcp.mcp_config import Tier, get_config, set_config, LocalLLMConfig
from esass.mcp.tier_router import TierRouter, get_router, RoutingResult, ExecutionResult
...
def main():
    """Entry point for esass-mcp-server console script."""
